    ...
    <div className="fixed inset-0 z-[110] terms-modal-overlay flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
          ...
          <p><strong>3. Цена и плащане:</strong><br/>Цената на продукта е 24.90 € за 50мл. Плащането се извършва чрез наложен платеж при доставка. Доставката се изпълнява чрез куриерски услуги Спиди или Еконт.</p>
