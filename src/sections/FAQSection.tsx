...
const faqs = [
  ...
  },
  {
    ...
    answer: "Продуктът е изцяло натурален и не съдържа консерванти, оцветители или синтетични добавки. При свръхчувствителност към някоя от 13-те билки, е възможно леко неразположение. Ако усетите нещо необичайно, спрете приема и се консултирайте с лекар. В противен случай, при правилна употреба, не са известни странични ефекти."
  },
  {
